...
export function DRSIndicator({ active, className, detected }: DRSIndicatorProps) {
  ...
  return (
    <div className={cn("flex items-center gap-1.5", className)} role="status" aria-label={`DRS ${active ? "active" : "inactive"}`}>
      <span
        className={cn(
          "text-[8px] font-mono uppercase tracking-wider font-bold transition-all duration-300",
      ...
      <span
        className={cn(
          "text-[7px] font-mono uppercase tracking-wider transition-all duration-300",
